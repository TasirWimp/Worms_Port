...
<div class="combat-message" aria-live="polite"></div>`;
    ...
    private refreshActions(): void {
        ...
        use.textContent = label; use.setAttribute('aria-label', label); use.title = armedReason ?? (this.choice ? this.choiceReason(this.choice) : '');
    ...
    private armedUseReason(): string | undefined { return this.choice ? this.choiceReason(this.choice) : this.state.aim && !this.choiceAffordable(this.state.selectedRelic)
